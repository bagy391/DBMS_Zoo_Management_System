					...
					<div class="container">
						<h2>welcome to zoo planet</h2>
							<div class="welcome-grids">
								...
								<?php
 $query=mysqli_query($con,"select * from ANIMAL_KIND order by rand() limit 4");
 ...
 ?>
								<div class="col-md-3 welcome-grid" >
									...
									<div class="wel-info">
										...
										<p><?php echo substr($row['Physical_Characteristics'],0,100);?>.</p>
									</div>
								</div><?php }?>
								<br>
								<div class="clearfix"></div>
					...
					<div class="animals">
						<div class="container">
							...
							<div class="clients">
								<ul id="flexiselDemo3">
									<?php
 $query=mysqli_query($con,"select * from ANIMAL_KIND");
 while ($row=mysqli_fetch_array($query)) {
 ?>
