...
if(isset($_POST['submit']))
 ...
 $ret=mysqli_query($con,"select * from CONTAINS where AGid='$AGid' and AKid='$AKid'");
...
echo "<script>alert('This Combination is already alloted');</script>";
        ...
        $query=mysqli_query($con, "insert into CONTAINS value('$AKid','$AGid')");
    if ($query) {

     echo '<script>alert(" Detail has been added.")</script>';
     header("location:contains.php");
  }
  else
    {
...
<head>
    ...
    <title>Add Contains - Zoo Management System</title>
